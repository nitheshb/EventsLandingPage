...
//     <div className="bg-white rounded-3xl p-8 shadow-lg transform transition duration-500 hover:scale-105 hover:bg-[#5a1d94]">
//         <h3 className="text-2xl font-semibold mb-2">title3</h3>
//         <p className="text-lg text-gray-600 mb-6">3 month</p>
//         <div className="text-4xl font-bold text-gray-900 mb-8">
//           <span className="text-2xl">Rs</span>250.00
//         </div>
...
//         <Link 
//           href="#"
//           className="block w-full py-3 px-6 text-center rounded-full bg-[#82E616] text-white font-semibold hover:bg-[#73cc16] transition duration-300"
//         >
//           Get Now
//         </Link>
//       </div>
...
//         <p className="text-lg text-gray-600 mb-6">6 month</p>
//         <div className="text-4xl font-bold text-gray-900 mb-8">
//           <span className="text-2xl">Rs</span>450.00
//         </div>
//         <ul className="space-y-4 mb-8 text-gray-600">
//           <li>30 items in the menu</li>
//           <li>Unlimited views</li>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <CardSpotlight radius={350} color="#6C2BD9">
            <div className="bg-[#171717] rounded-3xl p-8 text-white">
          ...
          <CardSpotlight radius={350} color="#FFFFFF">
            <div className="bg-[#171717] rounded-3xl p-8 text-white shadow-lg">
              <h3 className="text-2xl font-semibold mb-2">title3</h3>
          ...
          {/* Card 3 */}
          <CardSpotlight radius={350} color="#FFFFFF">
            <div className="bg-[#171717] rounded-3xl text-white p-8 shadow-lg">
              <h3 className="text-2xl font-semibold mb-2">title6</h3>
