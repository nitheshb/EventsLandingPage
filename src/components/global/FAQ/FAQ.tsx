...
export default function FAQ() {
  return (
    <div className="py-16 px-4 sm:px-6 lg:px-16 mt-4 rounded-[20px] mb-4 bg-[#f5f4f6] overflow-hidden">
      <h2 className="mb-6 text-3xl sm:text-4xl lg:text-5xl font-medium text-[#000]">
        Frequently asked questions
      </h2>
      <div className="border-2 border-[#e9e9e9] rounded-[20px]">
        {faqData.map((item, index) => (
